...
##Проверка сервисов
Для проверки своих сервисов можно использовать следующий чекер:

* python3 checker.py check (ip_сервиса)
* python3 checker.py put (ip_сервиса) (flag_id) (flag)
* python3 checker.py get (ip_сервиса) (flag_id) (flag)

Ответ 101 означает успешное выполнение. Порт можно изменить в самом чекере.
Есть ответ 102 103 104. 104 недоступен, 102 и 103 не верный ответ или сломан сервис.
